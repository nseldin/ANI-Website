(function () {
  ...
  const DETAIL_OVERRIDES = {
    ...
    "H. pylori breath/stool tests": {
      summary: "H. pylori urea breath testing and stool antigen testing are noninvasive tests for active Helicobacter pylori infection. They can be used for initial diagnosis and, when ordered at the correct time, to confirm eradication after treatment.",
      quickAnswer: "H. pylori breath and stool antigen tests look for active infection. Proton-pump inhibitors, bismuth, and antibiotics can suppress the organism and cause a false-negative result, so medication timing and the ordered hold instructions are part of interpreting the test—not optional preparation details.",
    ...
    "LFTs": {
      ...
      sections: [
        ...
        ["Urgent escalation", "Acute liver injury plus any new altered mental status, asterixis, or prolonged PT/INR is urgent. Suspected acetaminophen or toxic exposure, rapidly rising bilirubin or INR, hypoglycemia, hemodynamic instability, active bleeding, severe systemic illness, or new encephalopathy requires immediate provider or emergency-team notification. Acute encephalopathy with INR at least 1.5 and no known cirrhosis should trigger acute-liver-failure and transplant-center thinking because deterioration can be rapid."]
      ],
      resultMeanings: [
    ...
    "Bronchoscopy": {
      before: "Verify consent, NPO status, allergies, sedation plan, oxygenation, and baseline respiratory assessment.",
      after: "Monitor airway, gag reflex before oral intake, bleeding, pneumothorax signs, fever, oxygenation, and respiratory distress.",
      trap: "Blood-streaked sputum can be expected briefly; heavy bleeding or respiratory distress is not."
    },
    "Thoracentesis": {
      before: "Position upright leaning forward if tolerated, verify consent and coagulation risk, and assess baseline breath sounds/O2.",
      after: "Monitor breath sounds, oxygenation, puncture site, pneumothorax signs, cough, hypotension, and ordered chest x-ray.",
      trap: "Sudden dyspnea after thoracentesis can signal pneumothorax."
    },
    "Paracentesis": {
      before: "Have the client void if ordered, obtain weight/abdominal girth/vitals, verify consent, and assess bleeding risk.",
      after: "Monitor blood pressure, dizziness, leakage, bleeding, infection, fluid amount, albumin orders for large-volume removal, and respiratory comfort.",
      trap: "Removing ascites can drop preload and blood pressure. Watch for shock-like cues."
    },
    "Lumbar puncture": {
    ...
    "Colonoscopy": {
      before: "Bowel prep quality drives visibility. Verify consent, NPO/sedation plan, anticoagulants, and completion/tolerance of prep.",
      after: "Monitor sedation recovery, bleeding, perforation signs, severe abdominal pain, fever, and return of bowel function.",
      trap: "Severe abdominal pain or rigid abdomen after colonoscopy is not expected gas."
    },
    "EGD": {
      before: "Verify consent, NPO status, sedation plan, allergies, and aspiration risk.",
      after: "Keep NPO until gag reflex returns per policy; monitor bleeding, perforation signs, pain, fever, and sedation recovery.",
      trap: "Do not give oral intake until airway protective reflexes return."
    },
    "ERCP": {
      after: "Monitor for pancreatitis, abdominal pain, fever, bleeding, perforation, and sedation recovery.",
      trap: "Post-ERCP pancreatitis is a classic complication cue."
    },
    "Amniocentesis": {
    ...
    "Endobronchial ultrasound (EBUS)": {
      before: "Verify consent, NPO/sedation plan, oxygenation baseline, and bleeding risk if needle aspiration is planned.",
      after: "Monitor airway, gag reflex before oral intake, bleeding, pneumothorax signs, fever, and sedation recovery.",
      trap: "EBUS often samples lymph nodes. Bleeding and airway symptoms are the nursing watch-outs."
    },
    "Troponin I/T": {
