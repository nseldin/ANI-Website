...
(function () {
  ...
  const VERSION = "2026-07-21-wave37-diagnostics-b-5";
  ...
  const entries = [
    ...
    article({
      ...
      quickAnswer: "Cardiac MRI is best understood as a toolbox rather than one picture. Moving cine images show chamber size and contraction; flow sequences measure blood movement; stress perfusion asks whether coronary flow reserve is adequate; T2-based imaging is sensitive to water and edema; T1 and extracellular-volume methods assess interstitial change; T2* can quantify iron; and late gadolinium enhancement maps regions where extracellular contrast persists, such as scar or expanded interstitium. The pattern and clinical timing matter: enhancement is not automatically active myocarditis, and no enhancement does not exclude every cardiac disorder. Before scanning, verify the exact implant or device, retained metal and foreign-body risk, pregnancy, kidney function when contrast may be used, prior contrast reaction, ability to lie flat and follow breath-holds, and need for MR-safe monitoring or sedation. Never bring ordinary oxygen cylinders, pumps, tools, or resuscitation equipment into the scanner room.",
      resultMeanings: [
