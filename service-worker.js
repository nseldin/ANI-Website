const CACHE_VERSION = "ani-pwa-v375-web-f4156e95c8d9";
const APP_SHELL = [
  "/",
  "/index.html",
  "/app-config.js",
  ...
  "/data/clinical-frontier-wave45-therapeutic-nutrition-swallowing.js",
  "/data/clinical-frontier-wave46-transmission-precaution-links.js",
  "/data/mnemonic-library.js",
  "/data/learner-language-standard.js",
  "/data/medical-updates.js",
  "/data/medical-updates.json",
  "/src/ani/legal-consent.js",
  "/data/ani-content-manifest.js",
  "/data/ani-content-manifest.json",
  "/src/ani/gap-detector.js",
  "/src/ani/feedback-runtime.js",
  "/main.js",
